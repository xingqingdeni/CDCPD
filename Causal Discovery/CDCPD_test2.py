...
from analyze import analyze_causal_relations, calculate_precision
...
result_mosum = multiscale_struct_bottomUp(first_column_data_ranks, G = [180,220,320,400,500], eta = 2/3, alpha=0.01, distance = 1300,min_jump = 0.65)
...
### 第一阶段
    ...
    Variable X1 has 2 link(s):
        (X1 -1): pval = 0.00000 | val =  0.635
        (X0 -1): pval = 0.00000 | val =  0.562
    Variable X2 has 2 link(s):
        (X2 -1): pval = 0.00000 | val =  0.578
        (X1  0): pval = 0.00000 | val = -0.210
### 第二阶段
    Variable X0 has 3 link(s):
        (X1  0): pval = 0.00000 | val =  0.540 | unclear orientation due to conflict
        (X0 -1): pval = 0.00000 | val =  0.401
        (X0 -2): pval = 0.00000 | val =  0.227
    Variable X1 has 3 link(s):
        (X0  0): pval = 0.00000 | val =  0.540 | unclear orientation due to conflict
        (X1 -2): pval = 0.00002 | val =  0.109
        (X1 -1): pval = 0.00017 | val =  0.096
    Variable X2 has 2 link(s):
        (X1  0): pval = 0.00000 | val = -0.499
        (X2 -1): pval = 0.00000 | val =  0.456
### 第三阶段
    Variable X0 has 1 link(s):
        (X0 -1): pval = 0.00000 | val =  0.522
    Variable X1 has 2 link(s):
        (X0 -1): pval = 0.00000 | val =  0.782
        (X1 -1): pval = 0.00000 | val =  0.635
    Variable X2 has 2 link(s):
        (X2 -1): pval = 0.00000 | val =  0.411
        (X1  0): pval = 0.00000 | val = -0.271
"""
...
recall = (1459/4500)*(5/5)+(61/4500)*(4/5)+(1500/4500)*(5/6)+(13/4500)*(4/5)+(1487/4500)*(5/5)
