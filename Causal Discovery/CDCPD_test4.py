...
from analyze import analyze_causal_relations,convert_links
...
# result_mosum = mosum.mosum(first_column_data_ranks, G=400, criterion="et0, eta = 2/3, alpha=0.1, boundary_extension=True)
result_mosum = multiscale_struct_bottomUp(first_column_data_ranks, G = [100,150,200,280,300,400], eta = 2/3, alpha=0.01, distance = 880)
...
true_stages_causal = []
links_list = [links_1, links_2, links_3, links_4, links_5, links_6, links_7]
for links in links_list:
    stage_causal = convert_links(links)
...
### 第一阶段
    Variable X0 has 1 link(s):
        (X0 -1): pval = 0.00000 | val =  0.560
    Variable X1 has 2 link(s):
        (X1 -1): pval = 0.00000 | val =  0.522
        (X0 -1): pval = 0.00000 | val =  0.405
    Variable X2 has 2 link(s):
        (X2 -1): pval = 0.00000 | val =  0.413
        (X1 -1): pval = 0.00000 | val =  0.277
    Variable X3 has 2 link(s):
        (X3 -1): pval = 0.00000 | val =  0.347
        (X1 -1): pval = 0.00000 | val = -0.267
    Variable X4 has 3 link(s):
        (X3 -1): pval = 0.00000 | val =  0.551
        (X2 -2): pval = 0.00000 | val =  0.269
        (X4 -1): pval = 0.00000 | val =  0.220
### 第二阶段
    Variable X0 has 3 link(s):
        (X0 -1): pval = 0.00000 | val =  0.525
        (X1 -1): pval = 0.00000 | val =  0.508
        (X0 -4): pval = 0.00031 | val =  0.116
    Variable X1 has 3 link(s):
        (X1 -1): pval = 0.00000 | val =  0.211
        (X1 -3): pval = 0.00005 | val =  0.130
        (X0 -3): pval = 0.00006 | val =  0.129
    Variable X2 has 3 link(s):
        (X2 -1): pval = 0.00000 | val =  0.581
        (X1 -1): pval = 0.00000 | val =  0.565
        (X0 -3): pval = 0.00000 | val = -0.557
    Variable X3 has 3 link(s):
        (X3 -1): pval = 0.00000 | val =  0.585
        (X1  0): pval = 0.00000 | val = -0.230
        (X2 -1): pval = 0.00000 | val =  0.222
    Variable X4 has 2 link(s):
        (X2 -4): pval = 0.00000 | val =  0.309
        (X4 -1): pval = 0.00000 | val =  0.164
### 第三阶段
Variable X0 has 3 link(s):
        (X0 -1): pval = 0.00000 | val =  0.485
        (X1 -2): pval = 0.00000 | val =  0.174
        (X1 -1): pval = 0.00000 | val =  0.169
    Variable X1 has 2 link(s):
        (X1 -1): pval = 0.00000 | val =  0.663
        (X0 -4): pval = 0.00007 | val =  0.124
    Variable X2 has 2 link(s):
        (X2 -1): pval = 0.00000 | val =  0.432
        (X1 -1): pval = 0.00000 | val =  0.208
    Variable X3 has 2 link(s):
        (X1 -1): pval = 0.00000 | val = -0.333
        (X3 -1): pval = 0.00000 | val =  0.275
    Variable X4 has 3 link(s):
        (X3 -1): pval = 0.00000 | val =  0.564
        (X4 -1): pval = 0.00000 | val =  0.257
        (X2 -4): pval = 0.00000 | val =  0.250
### 第四阶段
Variable X0 has 3 link(s):
        (X0 -1): pval = 0.00000 | val =  0.537
        (X0 -4): pval = 0.00000 | val =  0.168
        (X1 -3): pval = 0.00060 | val =  0.111
    Variable X1 has 2 link(s):
        (X0 -1): pval = 0.00000 | val =  0.459
        (X1 -1): pval = 0.00000 | val =  0.312
    Variable X2 has 2 link(s):
        (X2 -1): pval = 0.00000 | val =  0.679
        (X1 -1): pval = 0.00000 | val =  0.440
    Variable X3 has 3 link(s):
        (X3 -1): pval = 0.00000 | val =  0.567
        (X2 -1): pval = 0.00000 | val =  0.272
        (X1  0): pval = 0.00000 | val = -0.259
    Variable X4 has 2 link(s):
        (X2 -4): pval = 0.00000 | val =  0.319
        (X4 -1): pval = 0.00000 | val =  0.214
### 第五阶段
    Variable X0 has 2 link(s):
        (X0 -1): pval = 0.00000 | val =  0.561
        (X0 -4): pval = 0.00000 | val =  0.191
    Variable X1 has 2 link(s):
        (X1 -1): pval = 0.00000 | val =  0.529
        (X0 -1): pval = 0.00009 | val =  0.123
    Variable X2 has 3 link(s):
        (X2 -1): pval = 0.00000 | val =  0.341
        (X1 -1): pval = 0.00000 | val =  0.236
        (X0 -4): pval = 0.00000 | val = -0.211
    Variable X3 has 3 link(s):
        (X1 -1): pval = 0.00000 | val = -0.316
        (X3 -1): pval = 0.00000 | val =  0.287
        (X2 -1): pval = 0.00000 | val =  0.211
    Variable X4 has 3 link(s):
        (X3 -1): pval = 0.00000 | val =  0.557
        (X2 -4): pval = 0.00000 | val =  0.313
        (X4 -1): pval = 0.00000 | val =  0.257
### 第六阶段
    Variable X0 has 2 link(s):
        (X0 -1): pval = 0.00000 | val =  0.537
        (X0 -4): pval = 0.00000 | val =  0.167
    Variable X1 has 2 link(s):
        (X0 -1): pval = 0.00000 | val =  0.497
        (X1 -1): pval = 0.00000 | val =  0.259
    Variable X2 has 2 link(s):
        (X2 -1): pval = 0.00000 | val =  0.625
        (X1 -1): pval = 0.00000 | val =  0.473
    Variable X3 has 3 link(s):
        (X3 -1): pval = 0.00000 | val =  0.584
        (X1  0): pval = 0.00000 | val = -0.274
        (X2 -1): pval = 0.00000 | val =  0.218
    Variable X4 has 2 link(s):
        (X2 -4): pval = 0.00000 | val =  0.338
        (X4 -1): pval = 0.00001 | val =  0.141
### 第七阶段
    Variable X0 has 1 link(s):
        (X0 -1): pval = 0.00000 | val =  0.488
    Variable X1 has 3 link(s):
        (X0 -1): pval = 0.00000 | val =  0.578
        (X1 -1): pval = 0.00000 | val =  0.533
        (X0 -3): pval = 0.00000 | val =  0.307
    Variable X2 has 2 link(s):
        (X2 -1): pval = 0.00000 | val =  0.398
        (X1 -1): pval = 0.00000 | val =  0.272
    Variable X3 has 2 link(s):
        (X3 -1): pval = 0.00000 | val =  0.278
        (X1 -1): pval = 0.00000 | val = -0.219
    Variable X4 has 3 link(s):
        (X3 -1): pval = 0.00000 | val =  0.592
        (X2 -4): pval = 0.00000 | val =  0.296
        (X4 -1): pval = 0.00000 | val =  0.192
"""
true_counts, tested_counts, same_counts_matrix = analyze_causal_relations(true_stages_causal, tested_causal)
#CDCPD_precision
precision = ((cpts[0]/sum) * 5/5 + (cpts[1] - cpts[0])/sum * 5/5 + (true_cpts[0] - cpts[1])/sum * 4/8
             + (true_cpts[1] - true_cpts[0])/sum * 5/8 + (cpts[2] - true_cpts[1])/sum * 4/8 + (true_cpts[2] - cpts[2])/sum * 5/5)
