...
n <- length(signal)
par(mfrow = c(5, 1))
plot(ts(ts),col = "darkgray",main="原序列",xlab="",ylab="")
...
plot(m1$stat,type = "l",lty = 1,main = "mosum",xlab = "G = 10 alpha = 0.1 and 0.5",ylab = "")
...
plot(m2$stat,type = "l",lty = 2,main = "mosum",xlab = "G = 25 alpha = 0.1 and 0.5",ylab = "")
...
plot(m3$stat,type = "l",lty = 2,main = "mosum",xlab = "G = 50 alpha = 0.1 and 0.5",ylab = "")
...
plot(m4$stat,type = "l",lty = 2,main = "mosum",xlab = "G = 60 alpha = 0.1 and 0.5",ylab = "")
...
plot(m1$stat,type = "l",lty = 2,main = "mosum",xlab = "G = 10 alpha = 0.1 and 0.5",ylab = "")
abline(v = m1$cpts, col = 2)
...
summary(mbu2)
mlp <- multiscale.localPrune(rankts, G = c(10, 25, 50, 60),var.est.method = 'mosum',criterion = "epsilon",epsilon =2/3)
...
lines(signal, col = 2, lwd = 2, lty = 2)
abline(v = c(11,21,31,41,51,61,71,81,91,101,111,121,131),lwd = 3.5, col = "blue",lty=3)
mbu1 <- multiscale.bottomUp(rankts,G = c(8,10,20),eta = 2/3,var.est.method = 'mosum')
plot(mbu1,type = "l",lty = 2,main = "mosum",xlab = "G = 10 alpha = 0.1 and 0.5",ylab = "")
plot(mbu1,display = "data", shaded = 'none') 
plot(mbu1, display = "significance", shaded = "CI")
summary(mbu1)
...
mbu2 <- multiscale.bottomUp(rankts, G = c(8,10,20),var.est.method = 'mosum',threshold = "custom",threshold.function = threshold.custom)
plot(mbu2,type = "l",lty = 2,main = "mosum",xlab = "G = 10 alpha = 0.1 and 0.5",ylab = "")
plot(mbu2,display = "data", shaded = 'none') 
plot(mbu2, display = "significance", shaded = "CI")
summary(mbu2)
mlp <- multiscale.localPrune(rankts, G = c(8,10,20),var.est.method = 'mosum',criterion = "epsilon",epsilon =2/3)
plot(mlp,type = "l",lty = 2,main = "mosum",xlab = "G = 10 alpha = 0.1 and 0.5",ylab = "")
plot(mlp,display = "data", shaded = 'none') 
plot(mlp, display = "significance", shaded = "CI")
summary(mlp)
